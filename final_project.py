...
def database(connection):
    ...
    except Error as haha:
        print('There has been an error:', haha)
    return connect
...
def create_table(connection, query):
    ...
    try:
        ...
        connection.commit()
        print(f"Execution is successful")
    except Error as haha:
        print(f"There has been an error: {haha}")
...
def read_table(connection, query):
    ...
    try:
        ...
        print(f"Looks like there is an error: {haha}")
...
print('Hi, I hope your having a good day.\n'
      'There is a tool call sqlite and you are gonna be able to try it today!\n'
      'You will need to use menus and then proceed as you please.\n'
      'I hope you enjoy!')
...
while menu != "END":
    ...
    while choice != "Any String Of Text":
        try:
            choice = int(choice)
            if 5 > choice > 0:
                break
    ...
    if choice == 1:
        ...
        while menu != "END":
            ...
            if choice == 5:
                ...
                while zip_code != "Any Long String Of Text":
                    try:
                ...
                city = input("\nWhat City does the customer live?"
                             "\n>>>").title()

                state = input("\nEnter the State the customer lives in?"
                              "\n>>>").title()
            ...
            # Allows user to modify information in the person table excluding the ID.
                ...
                while category != "Any String Of Text":
                    try:
                ...
                yup = category.replace("_", " ").title()
                # asks for the current value
                value = input(f"What does the current {yup}?"
                              f"\n>>>").title()
                ...
                new_val = input(f"What do you want to change {yup} to?"
                                f"\n>>>").title()
                ...
                if category == "zip_code":
                    while category != "Any String Of Text":
                        try:
                            ...
                            value = input("Enter a Zip Code."
                                          "\n>>>")

                # Asks for the Customer ID, without it it would modify everyone's value
                value1 = input("\nWhat is the Customer ID of the customer that is being modified?"
                               "\n>>>")
                ...
                while value1 != "Random Words":
                    try:
                        ...
                        value1 = input("\nEnter the ID of the Customer that is being deleted"
                                       "\n>>>")
                ...
                value = input("\nWhat is the Customer ID of the person that is being removed?"
                              "\n>>>")
                ...
                while value != "Random Words":
                    try:
                        ...
                        value = input("\nEnter the ID of the Customer that will be deleted"
                                      "\n>>>")
                value1 = input("\nOkay thanks, now what is the Last Name of the customer?"
                               "\n>>>\n").title()
                delete_person = f"""
                DELETE FROM 
                  customer
            ...
            # Prints the list of people in the database
                ...
                for ceo in people:
                    print(f'\nCUSTOMER ID: {ceo[0]} | FIRST NAME: {ceo[1]} | LAST NAME: {ceo[2]} | ADDRESS: {ceo[3]}'
                          f' | ZIP CODE: {ceo[4]} | CITY: {ceo[5]} | STATE: {ceo[6]}')
    ...
    # This section of the program is for the book menu
        ...
        while menu != 'END':
            ...
            while choice != "Any Long String Of Text":
                try:
                    choice = int(choice)
                    if 6 > choice > 0:
                        break
            ...
            if choice == 5:
                ...
                isbn = input("\nWhat is the ISBN of the book? "
                             "\n>>>")
                while isbn != " This code is so long!":
                    try:
                ...
                while edition != "Can't believe this went by so fast":
                    try:
                        edition = int(edition)
                        break
                    except ValueError:
                ...
                while price != "Finishing this at the last minute like always.":
                    try:
                        ...
                        price = input("\nEnter the Price of the book please."
                                      "\n>>>")
                ...
                if category == "Edition":
                    # Checks if the user entered a digit
                    while value != "BeepBoop":
                        try:
                            value1 = int(value)
                            break
                        except ValueError:
                            value = input("\nPlease enter the number of the current Edition."
                                          "\n>>>")

                if category == 'price':
                    # Uses the same method as the ISBN variable
                    while value != "This has taken hours":
                        try:
                ...
                if category == "edition":
                    # Checks if the user entered a digit
                    while value1 != "Lets go!":
                        try:
                            value1 = int(value1)
                            break
                        except ValueError:
                            value1 = input("\nPlease enter the number of the Edition. "
                                           "\n>>>")

                if category == 'price':

                    while value1 != "Keep on going!":
                        try:
                ...
                while value2 != "Very little sleep!":
                    try:
            ...
            # This section allows the user to delete a book from the table
                ...
                value1 = input("\nOkay, now what is the ISBN of that book?"
                               "\n>>>")
                # Same ISBN checks as before
                while value1 != "Kinda beat":
                    try:
        ...
        while menu != "END":
                            ...
                            for checks in check:
                                ...
                                if book_id == checks:
                                    print("\nYou can't order this book again in this order."
                                          "\nI will take you to the menu to place a new order"
            ...
            # If the user chooses this then can delete an order they made
                ...
                try:
                    ...
                    print("\nIt seems you are not in the database."
                          "\nPlease enter ADD yourself from the Customer Menu"
                          "\nCheck for unwanted spacing, or accidental spacing in the database"
                          "\nIf the latter occurs you can always MODIFY your Name in our system")
                    break
